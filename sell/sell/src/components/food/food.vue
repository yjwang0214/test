    ...
    <div class="food" v-show="showFlag" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          :desc="desc" :ratings="food.ratings" v-on:ratingtype-select="ratingtypeSelect"
  ...
  export default {
    ...
    methods: {
      ...
      addFirst (event) {
        ...
        this.$emit('cart-add', event.target); // 派发事件给父组件,实现小球下落动画
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .food
    ...
    &.move-enter, &.move-leave-active
      transform translate3d(100%, 0, 0) /* 相对自身宽度的平移 */
    .image-header
      position relative
      width 100%
      height 0
      padding-top 100% /* 使容器的高度等于宽度 */
      img
        position absolute
        top 0
        left 0
